...
// Added array variable to store the pizza objects so they don't have to be selected every time a user scrolls
var pizzaArray = [];
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // Ported from the function determineDx and changed to work with percentage values
    switch(size) {
        case "1":
          newWidth = 25;
          break;
